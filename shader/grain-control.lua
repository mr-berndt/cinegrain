...
local presets = {
    ...
    { name = "35mm low",  INTENSITY=0.085, PEAK=0.40, ROLLOFF=0.40, GRAIN_SIZE=0.50, COARSE_MIX=0.65, BLUR=0.40, CHROMA=0.10, SOFTNESS=0.05 },
    { name = "35mm mid",  INTENSITY=0.125, PEAK=0.40, ROLLOFF=0.40, GRAIN_SIZE=0.50, COARSE_MIX=0.75, BLUR=0.65, CHROMA=0.08, SOFTNESS=0.15 },
    { name = "35mm high", INTENSITY=0.135, PEAK=0.40, ROLLOFF=0.40, GRAIN_SIZE=0.50, COARSE_MIX=0.10, BLUR=0.90, CHROMA=0.05, SOFTNESS=0.25 },
    { name = "16mm low",  INTENSITY=0.100, PEAK=0.40, ROLLOFF=0.40, GRAIN_SIZE=1.35, COARSE_MIX=0.65, BLUR=0.40, CHROMA=0.05, SOFTNESS=0.85 },
    { name = "16mm high", INTENSITY=0.095, PEAK=0.40, ROLLOFF=0.40, GRAIN_SIZE=1.80, COARSE_MIX=0.90, BLUR=0.90, CHROMA=0.05, SOFTNESS=0.65 },
    { name = "8mm low",   INTENSITY=0.090, PEAK=0.40, ROLLOFF=0.40, GRAIN_SIZE=2.00, COARSE_MIX=0.70, BLUR=1.00, CHROMA=0.05, SOFTNESS=1.40 },
    { name = "8mm high",  INTENSITY=0.100, PEAK=0.40, ROLLOFF=0.40, GRAIN_SIZE=2.05, COARSE_MIX=0.70, BLUR=1.00, CHROMA=0.05, SOFTNESS=1.25 },
}
-- ──────────────────────────────────────────────────────────────────────────────
